    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // For more information on how to enable account confirmation and password reset please visit http://go.microsoft.com/fwlink/?LinkID=320771
                // Send an email with this link
                //The stuff below, we uncommented to make our email to work. 
        ...
        public async Task<ActionResult> ResendEmailConfirmation(ForgotPasswordViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                var callbackUrl = Url.Action("ConfirmationEmail", "Account",
                    ...
                    Request.Url.Scheme);
                await UserManager.SendEmailAsync(user.Id, "Confirmation your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
            }
